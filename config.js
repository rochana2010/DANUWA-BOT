...
const defaultConfig = {
  ...
  ALIVE_MSG: "*Hello👋 RÒÇHĀŇA-BOŤ Is Alive Now😍*", // Change alive msg from here
  ...
  ownerNumber: ["94757017709"], // Replace your bot owner number here (same as bot owner number)
